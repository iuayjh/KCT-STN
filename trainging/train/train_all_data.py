...
def func1():
    ...
    for k in person.keys():
        ...
        try:
            ...
            ta = trainAgent(model, data, k, 'resluts/all_data_1219', optimizer=optimizer, scheduler=scheduler, loss=loss,
...
def func2():
    ...
    ta = trainAgent(model, data, 'all', 'resluts/all_data_1223', optimizer=optimizer, scheduler=scheduler,
