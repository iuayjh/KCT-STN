...
data_base = {
    ...
    'sample_rate': 256,
    'step_length': 100,
    'feature_record': '/root/sharedatas/mxg/fetigueDetectionTest/model_saved/pre_train_test_03-convencoder-parameter-12-24-16-24.pth',
    'transformer_record': '/root/sharedatas/mxg/fetigueDetectionTest/model_saved/pre_train_test_03-transformer-parameter-12-24-16-24.pth'
}
...
def func2():
    ...
    ta = trainAgent(model, data, '2e-5', f'resluts/{agent_name}', optimizer=optimizer, scheduler=scheduler,
