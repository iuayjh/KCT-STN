from model.ESTCNN import ESTCNN
...
def func1():
    ...
    for k in person.keys():
        ...
        ta = trainAgent(model, data, k, '../../resluts/ESTCNN/228', optimizer=optimizer, scheduler=scheduler, loss=loss,
...
def func2():
    ...
    ta = trainAgent(model, data, agent_name, '../../resluts/ESTCNN/228', optimizer=optimizer, scheduler=scheduler, loss=loss,
