...
def func1():
    ...
    for k in person.keys():
        ...
        try:
            ...
            ta = trainAgent(model, data, k, f'{base_root}/resluts/{agent_name}/kan_test228', optimizer=optimizer, scheduler=scheduler, loss=loss,
...
def func2():
    ...
    ta = trainAgent(model, data, 'all', f'{base_root}/resluts/{agent_name}/kan_test228', optimizer=optimizer, scheduler=scheduler,
