...
def func1():
    ...
    for k in person.keys():
        ...
        ta = trainAgent(model, data, k, '../../resluts/CNNLSTM-500-256/kanTest-228', optimizer=optimizer, scheduler=scheduler, loss=loss,
...
def func2():
    ...
    ta = trainAgent(model, data, agent_name, '../../resluts/CNNLSTM-500-256/kanTest-228', optimizer=optimizer, scheduler=scheduler, loss=loss,
