...
def func1():
    ...
    for k in person.keys():
        ...
        ta = trainAgent(model, data, k, f'{base_root}/resluts/{agent_name}/moreEpoch', optimizer=optimizer, scheduler=scheduler, loss=loss,
...
def func2():
    ...
    ta = trainAgent(model, data, 'all', f'{base_root}/resluts/{agent_name}/moreEpoch', optimizer=optimizer, scheduler=scheduler,
                            loss=loss, lr=lr2, epoch=200, cuda_settings=cuda_settings, batch_size=32, freeze=False)
    ta.training()
