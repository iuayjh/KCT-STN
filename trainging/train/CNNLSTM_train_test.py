from model.KCLSTN import CNNaLSTM2
...
def func1():
    ...
    for k in person.keys():
        ...
        ta = trainAgent(model, data, k, '../../resluts/CNNLSTM', optimizer=optimizer, scheduler=scheduler, loss=loss,
...
def func2():
    ...
    ta = trainAgent(model, data, agent_name, '../../resluts/CNNLSTM', optimizer=optimizer, scheduler=scheduler, loss=loss,
